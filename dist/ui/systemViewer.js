...
exports.SystemViewer = void 0;
const engine_1 = require("../core/engine");
const fact_1 = require("../core/fact");
const logger_1 = require("../utils/logger");
const validator_1 = require("../utils/validator");
class SystemViewer {
    constructor(initialSystem, config = {}) {
        this.currentSystem = initialSystem || null;
        this.engine = null;
        this.config = Object.assign({ enableRealTimeUpdates: true, maxHistoryEntries: 100, enablePerformanceTracking: true, autoRefreshInterval: 5000 }, config);
        this.logger = new logger_1.Logger('SystemViewer');
    ...
    validateCurrentSystem() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.validator.validateSystem(this.currentSystem);
        });
    }
    ...
    displayOverview() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const validation = yield this.validateCurrentSystem();
    ...
    displayEntities() {
        ...
        this.currentSystem.entities.forEach((entity, index) => {
            ...
            if ((_a = entity.values) === null || _a === void 0 ? void 0 : _a.length) {
                console.log(`   Values: ${entity.values.slice(0, 5).join(', ')}${entity.values.length > 5 ? '...' : ''}`);
            }
            if ((_b = entity.patterns) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    displayExecutionHistory(limit = 10) {
        console.log('\n📝 EXECUTION HISTORY');
        console.log('─'.repeat(40));
        ...
        try {
            ...
            if (typeof input === 'object') {
                for (const [key, value] of Object.entries(input)) {
                    this.engine.addFact(new fact_1.Fact(key, value, 'user', 1.0));
                }
            }
    ...
    exportSystemReport(format = 'json') {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.currentSystem) {
                throw new Error('No system loaded');
            }
            switch (format) {
                case 'json':
                    return yield this.exportAsJSON();
                case 'html':
    ...
    recordExecution(input, result, duration, success) {
    ...
    updateStats(result, duration, success) {
    ...
    calculateAverageConfidence() {
        if (!this.currentSystem || this.currentSystem.rules.length === 0)
            return 0;
        ...
        this.currentSystem.rules.forEach(rule => {
            if (rule.condition.entities) {
                rule.condition.entities.forEach(entity => {
                    const relatedRules = this.currentSystem.rules.filter(r => { var _a; return r.id !== rule.id && ((_a = r.condition.entities) === null || _a === void 0 ? void 0 : _a.includes(entity)); });
    ...
    exportAsJSON() {
        return __awaiter(this, void 0, void 0, function* () {
            return JSON.stringify({
                ...
                validation: yield this.validateCurrentSystem(),
...
*Report generated on ${new Date().toLocaleString()}*`;
    ...
    startAutoRefresh() {
        if (!this.config.enableRealTimeUpdates || !this.config.autoRefreshInterval)
            return;
...
exports.SystemViewer = SystemViewer;

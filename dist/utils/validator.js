...
exports.SystemValidator = exports.validateFact = exports.validateRule = void 0;
...
exports.validateFact = validateFact;
class SystemValidator {
    ...
    validateSystem(system) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!system.domain)
                errors.push('System domain is required');
     ...
     */
    validateCrossReferences(system) {
        const errors = [];
        const warnings = [];
        ...
        entityNames.forEach(entityName => {
            const usedInIntents = system.intents.some(intent => intent.entities.includes(entityName));
            const usedInRules = system.rules.some(rule => { var _a; return (_a = rule.condition.entities) === null || _a === void 0 ? void 0 : _a.includes(entityName); });
    ...
    validateRule(rule) {
        ...
        if (!rule.name)
            warnings.push('Rule name is recommended');
        if (!rule.condition)
